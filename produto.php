...
require_once 'wcm/model/produtomedida.class.php';
...
<script type="text/javascript">
	...
	function validaQuantidade(produtoId) {
		...
		if(quantidadeProduto == '') {
			...
			location.href="addcarrinho.php?acao=comprar&quantidadeProduto="+quantidadeProduto+"&produtoId=" + produtoId+"&medida="+medida;
		}
	}
</script>
</head>
            ...
            <div class="span7">
              ...
              <?php
	          	if ($objProduto->getQuantidade() == 0) {?>
	              	...
	              	<?php
	              	if (count($objProduto->getListaMedidas()) > 0) { 
		              	?>
		              	Tamanho: 
		              	<select class="span1" name="medida" id="medida">
		              	<?php
		              	foreach ($objProduto->getListaMedidas() as $produtoMedida) {
		              		if ($produtoMedida->getQuantidade() > 0) {
			              		?>
			              		<option value="<?php echo $produtoMedida->getMedida();?>"><?php echo $produtoMedida->getMedida();?></option>
			              		<?php
		              		}
		              	} 
		              	?>
