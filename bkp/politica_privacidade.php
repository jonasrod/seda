...
<div id="maincontainer">
  ...
  <!-- Featured Product-->
  <section id="featured">
    <h1 class="headingfull"><span>POL&Iacute;TICA DE PRIVACIDADE</span></h1>
    <div class="sidewidt" style="padding: 20px; text-align: justify;"><br />
Discrição Total! Para sua privacidade e segurança, todos os nossos produtos são embalados e despachados em embalagens super discretas, invioláveis e sem nenhuma informação de origem ou sobre o conteúdo interno, portanto não há nada que faça lembrar um produto de sexshop. O remetente virá com um nome que não identificará o ramo de atividade de nossa empresa garantindo assim sua total discrição. E o mesmo se aplica às diferentes formas de pagamento.<br /><br />
As Informações fornecidas serão usadas exclusivamente para fornecer um serviço eficiente.<br /><br />
Tomaremos todas as medidas apropriadas para proteger a sua privacidade.<br /><br />
Ambiente Seguro, criptografado.<br /><br />
Ainda assim, considerando o constante avanço da tecnologia de invasões; Não nos responsabilizamos por atos de terceiros que logrem êxito em coletar ou utilizar, dados cadastrais e informações disponibilizadas em seu cadastro.
<br />&nbsp;
    </div>
  </section>
</div>
