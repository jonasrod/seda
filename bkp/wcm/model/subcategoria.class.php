...
class Subcategoria
{
	...
	public function obterSubcategoriaPorNome( $subcategoria )
	{
		$sql = "select * from subcategoria where LOWER(descricao) like '%$subcategoria%'";
		echo $sql.'<br />';
	...
	public function listarSubcategoriaComFiltro($result = '')
    {
        if ($result->num_rows > 0)
            return $this->montarLista($result);
        else
