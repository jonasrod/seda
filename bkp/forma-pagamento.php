...
<script type="text/javascript">
	function valida() {
		...
		if (!$("#pagseguro").is(":checked") && !$("#boleto").is(":checked") && !$("#transferencia").is(":checked") && !$("#cielo").is(":checked")) {
  ...
  <form action="forma-pagamento-controle.php?session=<?php echo session_id();?>" method="post">
    <div class="control-group">
                ...
                <div class="controls">
				 ...
				 <label class="radio">
                    <input type="radio" name="formaPagamento" id="pagseguro" value="pagseguro">
                    <img src="images/bandeira/pag2.jpg" > </img></label>
				  ...
				  <br><br>
				   ...
				   <label class="radio">
                    ...
                    <img src="images/bandeira/bol2.jpg" > </img></label>
                  
				  <br><br>
				  
				  
				   <label class="radio">
                    <input type="radio" name="formaPagamento" id="transferencia" value="transferencia">
                    <img src="images/bandeira/bra2.jpg" > </img></label>
                  
				  <br><br>
				  
				  <label class="radio">
                    <input type="radio" name="formaPagamento" id="cielo" value="cielo">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img src="images/bandeira/logo_cielo.png" > </img></label>
                  
				  <br><br>
				  
				  <input type="submit" class="btn btn-success pull-left" value="Continuar" onClick="return valida()" />
