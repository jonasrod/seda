...
<script type="text/javascript">
	...
	<?php 
	if (isset($_SESSION['mensagem_estoque'])) {
          ...
          if (isset($result_produto_carrinho)) {
	          ...
	          foreach($objProduto->listarCategoriaComFiltro( $result_produto_carrinho ) as $produto) {
		          ...
		          <tr>
		            ...
		            <td class="quantity"><input type="text" class="span1" name="quantidade" id="quantidade<?php echo $produto->getProdutoId();?>" value="<?php echo $_SESSION['carrinho'][$produto->getProdutoId()]['quantidade'];?>" size="1" onBlur="calculaValorQuantidade(<?php echo $produto->getProdutoId();?>)"></td>
		            ...
		            <td class="total"><a href="delcarrinho.php?produtoId=<?php echo $produto->getProdutoId();?>"><img alt="" src="images/remove.png" data-original-title="Remove" class="tooltip-test"></a></td>
		          </tr>
		     	  <?php
		      }
		          ...
		          <div class="span4 pull-right">
		            <table class="table table-striped table-bordered ">
		              <tbody><tr>
		                ...
		                <td><span class="bold" id="valorSubtotalCarrinho">R$ <?php echo Data::formataMoeda($valor_total_carrinho);?></span></td>
		              </tr>
		              <tr>
		              ...
		              <tr>
		                ...
		                <td><span class="bold totalamout" id="valorTotalCarrinho">R$ <?php echo Data::formataMoeda($valor_total_carrinho + Data::formataMoedaBD($valor_frete));?></span></td>
		              </tr>
		            </tbody></table><br>
		            <button class="btn btn-success pull-right" onClick="return concluir()">Finalizar</button>
		            ...
		            <a class="btn pull-right mr10" href="index.php">Continuar Comprando</a>
		          </div>
		        </div>
		      </div>
			  <br><br>
			   <form class="form-vertical form-inline" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
			  	<div class="cartoptionbox">
		          	<h4 class="heading4"> Tipo Frete</h4>
		          
		            <div class="control-group">
		            	<input type="radio" class="span3" name="tipoFrete" id="pac" value="41106" <?php echo (isset($_POST['tipoFrete']) && $_POST['tipoFrete'] == '41106')  ? 'checked' : '' ;?>>PAC<br />
		            	<input type="radio" class="span3" name="tipoFrete" id="sedex" value="40010" <?php echo (isset($_POST['tipoFrete']) && $_POST['tipoFrete'] == '40010') ? 'checked' : '' ;?>>SEDEX
		            </div>
			    ...
			    <div class="cartoptionbox">
		          ...
		          <fieldset>
		            <div class="control-group">
		              <label class="control-label">Digita&ccedil;&atilde;o de CEP</label>
		              <div class="controls">
		                <input type="text" class="span3" name="cep" id="cep" value="<?php echo (isset($_POST['cep'])) ? $_POST['cep'] : '' ;?>" maxlength="9">
		               
		                <input type="submit" class="btn btn-success" value="Calcular" onClick="return validaCep()">
		              </div>
		            </div>
		          </fieldset>
