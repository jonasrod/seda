...
$objPaginacao = new Paginacao($objProduto->listarProdutoLancamento(), $quantidadePorPagina);
...
<div id="maincontainer">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="lancamento.php">Lan&ccedil;amento</a><span class="divider">/</span></li>
		...
		<div class="row">
            ...
            <!--sidebar Ends-->
            <div class="span9">
          <h1 class="productname">Lan&ccedil;amentos</h1>
          <section id="latest">
            <div class="row">
              <div class="span9">
                ...
                <section id="thumbnails">
                  <ul class="thumbnails grid" style="display: block;">
				  	<?php
			        //foreach( $objProduto->listarProdutoComFiltro( $result_produto_promocao ) as $produto ) {
			        foreach( $objProduto->listarProdutoLancamento($objPaginacao, $orderBy) as $produto ) {
			        	$objFile = new Files();
