...
class Bannerlateral
{
	...
	public function obterBannerlateral( $bannerlateralID )
	{
		$result = $this->bd->obterRegistroPorId( "bannerlateral", $bannerlateralID );
		return $this->montarObjeto( $result->fetch_array() );
	}

	public function listarBannerlateral( Paginacao $objPaginacao = NULL )
	{
		$sql  = "select * ";
