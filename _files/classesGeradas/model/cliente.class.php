...
include_once 'generoid.class.php';
include_once 'tipoclienteid.class.php';
...
class Cliente
{
	...
	private function montarObjeto( $row )
	{
		...
		$objGeneroId = new GeneroId();
		$objGeneroId->obterGeneroId( $row["mGeneroId"] );

		$this->setGeneroId( $objGeneroId );

		$objTipoClienteId = new TipoClienteId();
		$objTipoClienteId->obterTipoClienteId( $row["mTipoClienteId"] );
