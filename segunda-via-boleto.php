...
$sql = "select * from venda where status = 1 and mTipoPagamentoId = 2 and mClienteId = " . $_SESSION['brw_idLogin'] . " order by dtCadastro asc";
...
<div id="maincontainer">
    ...
    <div class="container">
      ...
      <h1 class="productname">Meus de Pedidos</h1>
      <div class="cart-info">
        <table class="table table-striped table-bordered">
          ...
          foreach( $objVenda->listarComFiltro( $result ) as $venda ) { ?>
	          ...
	          <tr>
	            ...
	            <td class="quantity"><a href="boleto/boleto_bradesco.php?numPedido=<?=$venda->getReferencia()?>" target="_blank">Segunda via Boleto</a></td>
	          </tr>
		      <?php
          }
		  ?>
