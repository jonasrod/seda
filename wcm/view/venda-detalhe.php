...
<div class="span12 imprime-pedido">
<div class="row-fluid">
	...
	<table class="table table-striped sortable">
		...
		foreach( $objCarrinhoProduto->listarComFiltro( $result ) as $carrinhoProduto ) {
			...
			<tr>
				...
				<td><?=$carrinhoProduto->getMedida()?></td>
		...
		?>
			...
			?>
				<tr>
				 	<td colspan="5" style="text-align: right"><strong>Deconto pagamento boleto ou transfer&ecirc;ncia 5%</strong></td>
			...
			<tr>
			 	<td colspan="5" style="text-align: right"><strong>Frete</strong></td>
