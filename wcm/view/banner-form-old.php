...
<div class="control-group">
	<label class="control-label span3" for="flPromocao">Promo&ccedil;&atilde;o</label> 
	<input type="checkbox" name="flPromocao" id="flPromocao" value="1" <?php echo ($objProduto->getFlPromocao() == 1) ? 'checked="true"' : '';?>/>
</div>

<div class="control-group">
	<label class="control-label span3" for="flLancamento">Lan&ccedil;amento</label> 
...
<div class="span6">
<div class="row-fluid">
	<form id="fileupload" action="server/banner/index.php" method="POST" enctype="multipart/form-data">
...
<script src="../jquery-file-upload-9.5.7/js/banner.js"></script>
