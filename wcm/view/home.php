 ...
 ***********************************************************/
$sql  = 'select * from produto where quantidade <= quantidadeMinima and status = 1 order by quantidade asc';
...
<div class="span12">
  <h4 class="header">
  	Resumo 
  	<a href="index.php?p=desconto-frete-form" class="btn btn-small btn-success btn-form">Desconto Frete</a>
  	<a href="index.php?p=banner-form" class="btn btn-small btn-success btn-form">Cadastro Banner</a>
  	<a href="index.php?p=banner-lateral-form" class="btn btn-small btn-success btn-form">Cadastro Banner Lateral</a>
  </h4>
</div>
			...
			<div class="span12">
				<div class="table-panel">
					<table id="datatable" class="table table-striped sortable">
						<thead>
							<tr>
								<th class="header">C&oacute;digo</th>
						...
						<tbody>
							...
							<tr <?php echo ($produto->getQuantidade() == 0) ? 'style="color: red;"' : '' ?>>
								<th><?php echo $produto->getCodigoProduto(); ?></th>
