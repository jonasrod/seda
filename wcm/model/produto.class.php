...
include_once 'produtomedida.class.php';
...
class Produto
{
	...
	public function setListaMedidas( $listaMedidas )
	{
	...
	private function montarObjeto( $row )
	{
		...
		$this->setListaMedidas($objProdutoMedida->listarProdutomedida( $row["produtoId"] ));
